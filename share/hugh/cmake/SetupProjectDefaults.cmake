...
if(${PROJECT_NAME}_FILE_SO)
  ...
  if(VERBOSE)
    message(STATUS "Loaded project-specific options from 'CMakeAddons_SetupOptions'")
  endif()
endif()
...
if(${PROJECT_NAME}_FILE_SP)
  ...
  include(CMakeAddons_SetupPaths)
  if(VERBOSE)
    message(STATUS "Loaded project-specific paths from 'CMakeAddons_SetupPaths'")
  endif()
endif()
...
if(${PROJECT_NAME}_FILE_SV)
  ...
  if(VERBOSE)
    message(STATUS "Loaded project-specific variables from 'CMakeAddons_SetupVariables'")
  endif()
endif()
